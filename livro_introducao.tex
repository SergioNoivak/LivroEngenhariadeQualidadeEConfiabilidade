...
\usetikzlibrary{arrows.meta,positioning,shapes.multipart,shapes.geometric,calc,fit,shadows}
...
\justifying\footnotesize\color{darkgray}
...
\begin{authorcard}
\centering
{\small\bfseries\color{azuluni} ADRIANO S. de O. BAILÃO}
...
\justifying\footnotesize\color{darkgray}
Leandro Sanches é Mestre em Ciências da Computação e Advogado, possui experiência em computação aplicada à educação, análise e desenvolvimento de software, banco de dados, processamento de linguagens naturais. Participou de projetos de desenvolvimento de software comerciais e educacionais.
\end{authorcard}
\end{minipage}
